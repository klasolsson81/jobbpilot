...
/// Unit-test i <c>Jobbliggaren.Migrate.UnitTests</c> låser factory:ns output, men skyddar
...
public class ConnectionStringLeakageTests
{
    ...
    public void Migrate_assembly_is_intentionally_excluded_from_scan()
    {
        ...
        var migrateAssembly = typeof(Jobbliggaren.Migrate.ConnectionStringFactory).Assembly;
