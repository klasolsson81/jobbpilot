...
public class JobAdSearchLayerTests
{
    ...
    public void IJobAdSearchQuery_is_in_Application_layer()
    {
        ...
        var port = typeof(JobbPilot.Application.JobAds.Abstractions.IJobAdSearchQuery);
    ...
    public void JobAdSearchCriteria_is_in_Application_layer()
    {
        ...
        var criteria = typeof(JobbPilot.Application.JobAds.Abstractions.JobAdSearchCriteria);
        criteria.Assembly.ShouldBe(typeof(JobbPilot.Application.AssemblyMarker).Assembly);
    }
    ...
    public void JobAdSearchQuery_impl_is_internal_to_Infrastructure()
    {
        ...
        var impl = typeof(JobbPilot.Infrastructure.AssemblyMarker).Assembly
            .GetTypes()
