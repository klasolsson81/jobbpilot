...
/// <see cref="JobbPilot.Infrastructure.Security.FieldEncryptionSaveChangesInterceptor"/>
...
public class FieldEncryptionInterceptorTests(WorkerTestFixture fixture)
{
    ...
    /// scope. Värmer ägar-DEK i scopets <see cref="JobbPilot.Infrastructure.Security.ScopedUserDataKeyCache"/>
