...
created: 2026-04-19T17:01:28+02:00
...
```
 ...
 M src/JobbPilot.Api/JobbPilot.Api.csproj
 M src/JobbPilot.Application/Common/Abstractions/IAppDbContext.cs
 M src/JobbPilot.Infrastructure/JobbPilot.Infrastructure.csproj
 D tests/JobbPilot.Domain.UnitTests/Smoke.cs
?? docs/sessions/precompact-2026-04-19-1336.md
?? docs/sessions/precompact-2026-04-19-1701.md
?? src/JobbPilot.Domain/JobAds/
?? src/JobbPilot.Infrastructure/DependencyInjection.cs
?? src/JobbPilot.Infrastructure/Persistence/
?? tests/JobbPilot.Domain.UnitTests/JobAds/
```
...
7e30f3e feat(src): scaffold 5 .NET projekt per ADR 0010 (Domain/App/Infra/Api/Worker)
f600208 feat(solution): JobbPilot.sln + Directory.Build.props + global.json (CPM)
