...
created: 2026-04-19T17:55:05+02:00
...
```
 ...
 M tests/JobbPilot.Application.UnitTests/JobbPilot.Application.UnitTests.csproj
...
?? src/JobbPilot.Application/JobAds/
?? tests/JobbPilot.Api.IntegrationTests/Infrastructure/
?? tests/JobbPilot.Api.IntegrationTests/JobAds/
?? tests/JobbPilot.Application.UnitTests/Common/FakeDateTimeProvider.cs
?? tests/JobbPilot.Application.UnitTests/Common/TestAppDbContextFactory.cs
?? tests/JobbPilot.Application.UnitTests/JobAds/
```
...
4c57c95 docs(decisions): ADR 0011 — strongly-typed IDs som record struct
b1f830e docs(session): session 6 — Fas 0 kod-scaffolding STEG 1
8703bd5 feat(husky): aktivera test-gates i pre-commit
39513b4 feat(tests): scaffold 4 xUnit v3 testprojekt med Shouldly
```
