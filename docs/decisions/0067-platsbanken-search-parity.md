...
- **docs-drift PENDING (E1a item 4, Klas-gated):** stale `#0B5CAD` → navy-800 i `jobbpilot-design-tokens`-skill är en spec-edit (klassificeraren blockerar CC-self-approve) → Klas kör `approve-spec-edit.sh`, committas in i E1a-PR efter approve.
