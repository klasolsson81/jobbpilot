...
**Senast uppdaterad:** 2026-05-17 (FAS 3-prerekvisit C perf-governance levererad & CI-grön: ADR 0045 Accepted, observe-only CI Fas 1, CLAUDE.md §2.5/§9.2, perf-test-writer-agent roster=13, release-checklist-runbook; coverage-gate ADR 0044 orörd & grön; BUILD.md §3.1 NBomber-rader PENDING — hook-block, Klas-beroende; docs-commit session-end ovanpå)
