...
**Senast uppdaterad:** 2026-05-17 (test-coverage-sidospår: in-repo-mekanism + ADR 0044 Proposed + B1/B2/B3-luckor stängda; PRIO-1 CI-fix dessförinnan)
**HEAD:** `472dbdb` (test(coverage) B1+B3; coverage-infra `2d262ee`, B2 `6768700`; first-party Line 92.1%/Branch 84.5%)
