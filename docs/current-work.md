...
**Senast uppdaterad:** 2026-05-17 (coverage-finalisering: ADR 0044 **Accepted** + per-lager regressions-gate aktiverad & blockerande + README-skryt; main-CI grön run `25989344497`)
**HEAD:** `d67d340` (docs(readme) coverage-skryt; CI-gate+Accepted-flip `ee4709a`; push `98b6f17..d67d340`; first-party Line 92.1%/Branch 84.5%)
