...
/// AWS Secrets Manager via env-var) och pekar mot <c>jobbliggaren_worker</c>-
...
/// <c>jobbliggaren_app</c> — lateral access-yta minskar.
///
    ...
    public static string Resolve(IConfiguration configuration)
    {
        ...
        return configuration.GetConnectionString(PrimaryKey)
            ...
            ?? throw new InvalidOperationException(
                ...
                $"jobbliggaren/<env>/postgres-worker — jobbliggaren_worker-roll, GRANT-modell §4) " +
