using JobbPilot.Application.SavedJobAds.Commands.SaveJobAd;
using JobbPilot.Application.SavedJobAds.Commands.UnsaveJobAd;
using JobbPilot.Application.SavedJobAds.Queries.ListSavedJobAds;
using Mediator;
