...
namespace Jobbliggaren.Infrastructure.Landing;
...
/// (<c>jobbliggaren:</c>) sätts av Redis-DI-konfigurationen, så fullständig
/// nyckel i Redis blir <c>jobbliggaren:landing:stats:v1</c>.
...
public sealed class RedisLandingStatsCache(IDistributedCache cache) : ILandingStatsCache
{
    ...
    // Wire-konsistens med Jobbliggarens minimal-API JSON-default (camelCase).
