// JobbPilot load-test-runner — ADR 0045 (performance-budgetar och fitness functions).
//
// SCOPE: NBomber-baserad fitness-function-runner. Detta projekt är medvetet
// utanför JobbPilot.sln (build.yml backend-jobb + coverage-gaten plockar EJ
...
using JobbPilot.LoadTests.Reporting;
using JobbPilot.LoadTests.Scenarios;
